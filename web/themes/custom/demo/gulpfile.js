...
const renameBaseScripts = (file) => {
  return path.relative(paths.base.scripts.src, file.path.replace('/libraries', `/${paths.base.scripts.src}`)
...
const baseStylesWatchTask = function (cb) {
  gulp.src(paths.base.styles.src, {
      sourcemaps: true,
      since: gulp.lastRun(baseStylesWatchTask),
    })
...
gulp.task("baseStylesWatch", baseStylesWatchTask);

const componentStylesWatchTask = function (cb) {
...
gulp.task("componentStylesWatch", componentStylesWatchTask);
...
const baseScriptsWatchTask = function (cb) {
  gulp.src(paths.base.scripts.src, {
      since: gulp.lastRun(baseScriptsWatchTask),
    })
...
gulp.task("baseScriptsWatch", baseScriptsWatchTask);

const componentScriptsWatchTask = function (cb) {
...
gulp.task("componentScriptsWatch", componentScriptsWatchTask);
...
exports.watch = () => {
  ...
  gulp.watch(paths.base.styles.src, watchOptions, gulp.series("baseStylesWatch"));
  gulp.watch(paths.base.scripts.src, watchOptions, gulp.series("baseScriptsWatch"));
